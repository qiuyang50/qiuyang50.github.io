...
The multi-scale interactions of tropical convection in the MJO sheds lights on many fundamental mechanisms for the observation. How to understand the barrier effect of the Maritime continent for the passage of the MJO? By developing systematically a theoretical framework, we showed that this barrier effect is related to the multi-time scale interactions between the diurnal cycle and the MJO over the Maritime Continent. 
